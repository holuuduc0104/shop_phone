...
<div class="container-fluid mt-1 success-bg" style="height: 500px; padding-top:100px;">
    ...
    <div class="col-md- text-white fs-3 mx-auto text-center">
        <p>Total amount payable is: <strong class="text-danger"><?php echo '$'.$fm->format_currency($amount); ?></strong></p>
        <p>See order details at <a href="order_history.php" class="text-danger">here</a></p>
    </div>
