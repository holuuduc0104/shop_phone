...
if (isset($_GET['delid'])) {
    ...
    if ($delBrand == 'true') {
        echo '<script>alert("Deleted Brand Successfully.");
           </script>';
    } else {
        echo '<script>alert("Deleted Brand Failed.");
        </script>';
    }
}
...
<div class="container-fluid mt-0">
    <div class="row justify-content-end">
        <div class="col-md-3 mb-2 mt-0">
            <button type="button" class="btn btn-info"><a href="brandadd.php">Add Brand</a></button>
        </div>
    </div>
                    ...
                    <table class="table table-striped brandlist mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width: 270px;">Brand Name</th>
